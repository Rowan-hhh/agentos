...
- [x] **Step 2: Create `agentos/__init__.py`**

```python
```

- [x] **Step 3: Create `agentos/core/__init__.py`**

```python
```

- [x] **Step 4: Create `agentos/llm/__init__.py`**

```python
```

- [x] **Step 5: Create `agentos/security/__init__.py`**

```python
```

- [x] **Step 6: Create `tests/__init__.py` and `tests/fixtures/__init__.py`**

```python
```

- [x] **Step 7: Write `agentos/core/state.py`**
...
- [x] **Step 8: Write `agentos/core/action.py`**
...
- [x] **Step 9: Write `agentos/llm/interface.py`**
...
- [x] **Step 10: Write failing tests for data structures**
...
- [x] **Step 1: Write `agentos/llm/mock.py`**
...
- [x] **Step 2: Write `agentos/security/credentials.py`**
...
- [x] **Step 3: Write `agentos/llm/real.py`**
...
- [x] **Step 4: Create `tests/test_real_llm.py` (integration-only marker)**
...
- [x] **Step 5: Run unit tests to verify no regressions**
...
- [x] **Step 2: Write `agentos/tools/read_file.py`**
...
- [x] **Step 3: Write `agentos/tools/write_file.py`**
...
- [x] **Step 4: Write `agentos/tools/execute_test.py`**
...
- [x] **Step 5: Write `agentos/tools/toolbox.py`**
...
- [x] **Step 2: Write `agentos/guardrail/rules.py`**
...
- [x] **Step 3: Write `agentos/guardrail/engine.py`**
...
- [x] **Step 2: Write `agentos/feedback/extractor.py`**
...
- [x] **Step 3: Write `agentos/feedback/controller.py`**
...
- [x] **Step 1: Write `agentos/core/loop.py`**
...
- [x] **Step 2: Write `agentos/core/agent.py` (re-export for clean imports)**
...
- [x] **Step 1: Write `agentos/main.py`**
...
- [x] **Step 2: Write `docker/Dockerfile`**
...
- [x] **Step 3: Write `docker/entrypoint.sh`**
...
- [x] **Step 4: Update `.env.example` if needed and verify `.gitignore`**
...
- [x] **Step 5: Run final full test suite**
